...
$masterdata_view = NULL; // Initialize page object first

class cmasterdata_view extends cmasterdata {
	...
	// Page object name
	var $PageObjName = 'masterdata_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_barang"] <> "") {
				...
				$sReturnUrl = "masterdatalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "masterdatalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "masterdatalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($masterdata_view)) $masterdata_view = new cmasterdata_view();

// Page init
$masterdata_view->Page_Init();

// Page main
$masterdata_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$masterdata_view->Page_Render();
?>
...
var CurrentForm = fmasterdataview = new ew_Form("fmasterdataview", "view");

// Form_CustomValidate event
fmasterdataview.Form_CustomValidate = 
...
fmasterdataview.ValidateRequired = true;
<?php } else { ?>
fmasterdataview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$masterdata_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $masterdata_view->ExportOptions->Render("body") ?>
<?php
	foreach ($masterdata_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$masterdata_view->IsModal) { ?>
...
<?php $masterdata_view->ShowPageHeader(); ?>
<?php
$masterdata_view->ShowMessage();
?>
<form name="fmasterdataview" id="fmasterdataview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($masterdata_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $masterdata_view->Token ?>">
<?php } ?>
...
<?php if ($masterdata->id_barang->Visible) { // id_barang ?>
	<tr id="r_id_barang">
		<td><span id="elh_masterdata_id_barang"><?php echo $masterdata->id_barang->FldCaption() ?></span></td>
...
<?php echo $masterdata->id_barang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($masterdata->jenis_barang->Visible) { // jenis_barang ?>
	<tr id="r_jenis_barang">
		<td><span id="elh_masterdata_jenis_barang"><?php echo $masterdata->jenis_barang->FldCaption() ?></span></td>
...
<?php echo $masterdata->jenis_barang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($masterdata->jenis_bahan->Visible) { // jenis_bahan ?>
	<tr id="r_jenis_bahan">
		<td><span id="elh_masterdata_jenis_bahan"><?php echo $masterdata->jenis_bahan->FldCaption() ?></span></td>
...
<?php echo $masterdata->jenis_bahan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($masterdata->kebutuhan->Visible) { // kebutuhan ?>
	<tr id="r_kebutuhan">
		<td><span id="elh_masterdata_kebutuhan"><?php echo $masterdata->kebutuhan->FldCaption() ?></span></td>
...
<?php echo $masterdata->kebutuhan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($masterdata->satuan->Visible) { // satuan ?>
	<tr id="r_satuan">
		<td><span id="elh_masterdata_satuan"><?php echo $masterdata->satuan->FldCaption() ?></span></td>
...
<?php echo $masterdata->satuan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($masterdata->harga->Visible) { // harga ?>
	<tr id="r_harga">
		<td><span id="elh_masterdata_harga"><?php echo $masterdata->harga->FldCaption() ?></span></td>
...
<?php echo $masterdata->harga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fmasterdataview.Init();
</script>
<?php
$masterdata_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$masterdata_view->Page_Terminate();
?>
