...
finventorydelete.ValidateRequired = true;
<?php } else { ?>
finventorydelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
finventorydelete.Lists["x_satuan_unit"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventorydelete.Lists["x_satuan_unit"].Options = <?php echo json_encode($inventory->satuan_unit->Options()) ?>;
finventorydelete.Lists["x_jenis"] = {"LinkField":"x_jenis_bahan","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_bahan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"masterdata"};
...
<?php if ($inventory->inventory_id->Visible) { // inventory_id ?>
		<th><span id="elh_inventory_inventory_id" class="inventory_inventory_id"><?php echo $inventory->inventory_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->deskripsi_item->Visible) { // deskripsi_item ?>
		<th><span id="elh_inventory_deskripsi_item" class="inventory_deskripsi_item"><?php echo $inventory->deskripsi_item->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->kuantitas->Visible) { // kuantitas ?>
		<th><span id="elh_inventory_kuantitas" class="inventory_kuantitas"><?php echo $inventory->kuantitas->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->satuan_unit->Visible) { // satuan_unit ?>
		<th><span id="elh_inventory_satuan_unit" class="inventory_satuan_unit"><?php echo $inventory->satuan_unit->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->jenis->Visible) { // jenis ?>
		<th><span id="elh_inventory_jenis" class="inventory_jenis"><?php echo $inventory->jenis->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->warna->Visible) { // warna ?>
		<th><span id="elh_inventory_warna" class="inventory_warna"><?php echo $inventory->warna->FldCaption() ?></span></th>
<?php } ?>
<?php if ($inventory->tanggal_masuk->Visible) { // tanggal_masuk ?>
		<th><span id="elh_inventory_tanggal_masuk" class="inventory_tanggal_masuk"><?php echo $inventory->tanggal_masuk->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($inventory->inventory_id->Visible) { // inventory_id ?>
		<td<?php echo $inventory->inventory_id->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_inventory_id" class="inventory_inventory_id">
...
<?php } ?>
<?php if ($inventory->deskripsi_item->Visible) { // deskripsi_item ?>
		<td<?php echo $inventory->deskripsi_item->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_deskripsi_item" class="inventory_deskripsi_item">
...
<?php } ?>
<?php if ($inventory->kuantitas->Visible) { // kuantitas ?>
		<td<?php echo $inventory->kuantitas->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_kuantitas" class="inventory_kuantitas">
...
<?php } ?>
<?php if ($inventory->satuan_unit->Visible) { // satuan_unit ?>
		<td<?php echo $inventory->satuan_unit->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_satuan_unit" class="inventory_satuan_unit">
...
<?php } ?>
<?php if ($inventory->jenis->Visible) { // jenis ?>
		<td<?php echo $inventory->jenis->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_jenis" class="inventory_jenis">
...
<?php } ?>
<?php if ($inventory->warna->Visible) { // warna ?>
		<td<?php echo $inventory->warna->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_warna" class="inventory_warna">
...
<?php } ?>
<?php if ($inventory->tanggal_masuk->Visible) { // tanggal_masuk ?>
		<td<?php echo $inventory->tanggal_masuk->CellAttributes() ?>>
<span id="el<?php echo $inventory_delete->RowCnt ?>_inventory_tanggal_masuk" class="inventory_tanggal_masuk">
