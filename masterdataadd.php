...
$masterdata_add = NULL; // Initialize page object first

class cmasterdata_add extends cmasterdata {
	...
	// Page object name
	var $PageObjName = 'masterdata_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "masterdataview.php")
...
// Create page object
if (!isset($masterdata_add)) $masterdata_add = new cmasterdata_add();

// Page init
$masterdata_add->Page_Init();

// Page main
$masterdata_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$masterdata_add->Page_Render();
?>
...
var CurrentForm = fmasterdataadd = new ew_Form("fmasterdataadd", "add");

// Validate form
fmasterdataadd.Validate = function() {
...
fmasterdataadd.Form_CustomValidate = 
...
fmasterdataadd.ValidateRequired = true;
<?php } else { ?>
fmasterdataadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $masterdata_add->ShowPageHeader(); ?>
<?php
$masterdata_add->ShowMessage();
?>
<form name="fmasterdataadd" id="fmasterdataadd" class="<?php echo $masterdata_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($masterdata_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $masterdata_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $masterdata_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
