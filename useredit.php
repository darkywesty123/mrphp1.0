...
<input type="text" data-password-strength="pst_password" data-password-generated="pgt_password" data-table="user" data-field="x_password" name="x_password" id="x_password" value="<?php echo $user->password->EditValue ?>" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($user->password->getPlaceHolder()) ?>"<?php echo $user->password->EditAttributes() ?>>
