...
$customer_view = NULL; // Initialize page object first

class ccustomer_view extends ccustomer {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["cust_id"] <> "") {
			$this->RecKey["cust_id"] = $_GET["cust_id"];
			$KeyUrl .= "&amp;cust_id=" . urlencode($this->RecKey["cust_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["cust_id"] <> "") {
				...
				$this->RecKey["cust_id"] = $this->cust_id->QueryStringValue;
			} elseif (@$_POST["cust_id"] <> "") {
				$this->cust_id->setFormValue($_POST["cust_id"]);
				$this->RecKey["cust_id"] = $this->cust_id->FormValue;
			} else {
...
// Create page object
if (!isset($customer_view)) $customer_view = new ccustomer_view();
...
var CurrentForm = fcustomerview = new ew_Form("fcustomerview", "view");

// Form_CustomValidate event
fcustomerview.Form_CustomValidate = 
...
fcustomerview.ValidateRequired = true;
<?php } else { ?>
fcustomerview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$customer_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $customer_view->ExportOptions->Render("body") ?>
<?php
	foreach ($customer_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$customer_view->IsModal) { ?>
...
<?php $customer_view->ShowPageHeader(); ?>
<?php
$customer_view->ShowMessage();
?>
<form name="fcustomerview" id="fcustomerview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($customer_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $customer_view->Token ?>">
<?php } ?>
...
<?php if ($customer->cust_id->Visible) { // cust_id ?>
	<tr id="r_cust_id">
		<td><span id="elh_customer_cust_id"><?php echo $customer->cust_id->FldCaption() ?></span></td>
...
<?php echo $customer->cust_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customer->nama_pelanggan->Visible) { // nama_pelanggan ?>
	<tr id="r_nama_pelanggan">
		<td><span id="elh_customer_nama_pelanggan"><?php echo $customer->nama_pelanggan->FldCaption() ?></span></td>
...
<?php echo $customer->nama_pelanggan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customer->alamat_pelanggan->Visible) { // alamat pelanggan ?>
	<tr id="r_alamat_pelanggan">
		<td><span id="elh_customer_alamat_pelanggan"><?php echo $customer->alamat_pelanggan->FldCaption() ?></span></td>
...
<?php echo $customer->alamat_pelanggan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customer->nomor_telepon_pelanggan->Visible) { // nomor telepon pelanggan ?>
	<tr id="r_nomor_telepon_pelanggan">
		<td><span id="elh_customer_nomor_telepon_pelanggan"><?php echo $customer->nomor_telepon_pelanggan->FldCaption() ?></span></td>
...
<?php echo $customer->nomor_telepon_pelanggan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($customer->jumlah_pesanan->Visible) { // jumlah_pesanan ?>
	<tr id="r_jumlah_pesanan">
		<td><span id="elh_customer_jumlah_pesanan"><?php echo $customer->jumlah_pesanan->FldCaption() ?></span></td>
		<td data-name="jumlah_pesanan"<?php echo $customer->jumlah_pesanan->CellAttributes() ?>>
<span id="el_customer_jumlah_pesanan">
<span<?php echo $customer->jumlah_pesanan->ViewAttributes() ?>>
<?php echo $customer->jumlah_pesanan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
